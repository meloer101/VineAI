...
const HeroPage = () => {
  return (
    <div className="relative w-full bg-black overflow-x-hidden">
      ...
      {/* ========== Hero 区 ========== */}
      <section className="relative z-10 flex min-h-screen flex-col items-center justify-center gap-8 px-4 pt-16">
        <TextType
          className="text-4xl font-bold tracking-tight text-white md:text-6xl text-center max-w-4xl"
          text={[
      ...
      >
        <div className="mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-4">
          ...
          <div className="mt-16 flex justify-center">
            <ArrowDown variant="white" className="rotate-90 h-8 w-8 md:h-10 md:w-10" />
          </div>
          ...
          <div className="relative mx-auto mt-12 max-w-4xl overflow-hidden rounded-2xl bg-white p-6 shadow-xl md:p-8">
            ...
            <div className="mb-4 flex justify-center">
              <img src={essayImg} alt="" className="max-h-48 w-auto object-contain md:max-h-64" />
            </div>
            ...
            <p className="mt-1 text-left text-xs text-gray-600">
              ᵃ Bursa Uludag University, Department of Textile Engineering, Bursa
              16059, Türkiye
              <br />
              ᵇ UNAM-National Nanotechnology Center, Bilkent University, Ankara
              06800, Türkiye
            </p>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div>
                ...
                <p className="mt-2 text-sm leading-relaxed text-gray-700">
                  ...
                  deposited on glass fabric via ALD was studied. Characterization
                  by FESEM, XRD, XPS, UV-Vis and PL revealed the influence of
                  annealing on structure and optical properties, with implications
            ...
            <div className="mt-2 columns-1 gap-6 text-sm leading-relaxed text-gray-700 md:columns-2">
              ...
              <p>
                ...
                influence their efficiency. This work examines Al-doped ZnO
                thin films on glass fibers for use in photocatalytic wastewater
                treatment.
              </p>
            </div>
          </div>
            ...
            <div className="grid gap-8 sm:grid-cols-3">
              <div>
                ...
                <ul className="mt-3 space-y-2">
                  {["Verdent", "Verdent for VS Code", "Verdent for Jetbrains"].map(
                    (item) => (
                      <li key={item}>
                        <a
                          href="#"
